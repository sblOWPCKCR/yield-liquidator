...
mod cauldron_mod {
    ...
    use std::sync::Arc;
    pub static CAULDRON_ABI: ethers_contract::Lazy<ethers_core::abi::Abi> =
    ...
    #[derive(Clone)]
    pub struct Cauldron<M>(ethers_contract::Contract<M>);
    ...
    impl<M: ethers_providers::Middleware> std::fmt::Debug for Cauldron<M> {
    ...
    impl<'a, M: ethers_providers::Middleware> Cauldron<M> {
        ...
        pub fn new<T: Into<ethers_core::types::Address>>(
            ...
            let contract =
                ethers_contract::Contract::new(address.into(), CAULDRON_ABI.clone(), client);
            Self(contract)
        }
        ...
        pub fn add_series(
            ...
            series_id: [u8; 6],
            base_id: [u8; 6],
            fy_token: ethers_core::types::Address,
        ) -> ethers_contract::builders::ContractCall<M, ()> {
            self.0
        ...
        pub fn build(
            ...
            M,
            (ethers_core::types::Address, [u8; 6], [u8; 6]),
        > {
            self.0
        ...
        pub fn debt(
            ...
            p0: [u8; 6],
            p1: [u8; 6],
        ) -> ethers_contract::builders::ContractCall<M, (u128, u32, u8, u128)> {
            self.0
        ...
        pub fn level(
            &self,
            vault_id: [u8; 12],
        ) -> ethers_contract::builders::ContractCall<M, I256> {
            self.0
        ...
        pub fn mature(&self, series_id: [u8; 6]) -> ethers_contract::builders::ContractCall<M, ()> {
            self.0
        ...
        #[doc = "Calls the contract's `rateOracles` (0x4df0ecf0) function"]
        pub fn rate_oracles(
            &self,
            p0: [u8; 6],
        ) -> ethers_contract::builders::ContractCall<M, ethers_core::types::Address> {
            self.0
                .method_hash([77, 240, 236, 240], p0)
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn series(
            &self,
            p0: [u8; 6],
        ) -> ethers_contract::builders::ContractCall<M, (ethers_core::types::Address, [u8; 6], u32)>
        {
            self.0
        ...
        #[doc = "Calls the contract's `setRateOracle` (0x480d411a) function"]
        pub fn set_rate_oracle(
            &self,
            base_id: [u8; 6],
            oracle: ethers_core::types::Address,
        ) -> ethers_contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([72, 13, 65, 26], (base_id, oracle))
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn stir(
            ...
            ink: u128,
            art: u128,
        ) -> ethers_contract::builders::ContractCall<M, ((u128, u128), (u128, u128))> {
            self.0
        ...
        pub fn asset_added_filter(&self) -> ethers_contract::builders::Event<M, AssetAddedFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `DebtLimitsSet` event"]
        pub fn debt_limits_set_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, DebtLimitsSetFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `IlkAdded` event"]
        pub fn ilk_added_filter(&self) -> ethers_contract::builders::Event<M, IlkAddedFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `RateOracleAdded` event"]
        pub fn rate_oracle_added_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, RateOracleAddedFilter> {
            self.0.event()
        }
        ...
        pub fn series_added_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, SeriesAddedFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `SeriesMatured` event"]
        pub fn series_matured_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, SeriesMaturedFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `SpotOracleAdded` event"]
        pub fn spot_oracle_added_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, SpotOracleAddedFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `VaultBuilt` event"]
        pub fn vault_built_filter(&self) -> ethers_contract::builders::Event<M, VaultBuiltFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `VaultDestroyed` event"]
        pub fn vault_destroyed_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, VaultDestroyedFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `VaultGiven` event"]
        pub fn vault_given_filter(&self) -> ethers_contract::builders::Event<M, VaultGivenFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `VaultPoured` event"]
        pub fn vault_poured_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, VaultPouredFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `VaultRolled` event"]
        pub fn vault_rolled_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, VaultRolledFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `VaultStirred` event"]
        pub fn vault_stirred_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, VaultStirredFilter> {
            self.0.event()
        }
        #[doc = "Gets the contract's `VaultTweaked` event"]
        pub fn vault_tweaked_filter(
            &self,
        ) -> ethers_contract::builders::Event<M, VaultTweakedFilter> {
            self.0.event()
        }
        #[doc = r" Returns an [`Event`](#ethers_contract::builders::Event) builder for all events of this contract"]
        pub fn events(&self) -> ethers_contract::builders::Event<M, CauldronEvents> {
    ...
    pub struct RateOracleAddedFilter {
        ...
        pub base_id: [u8; 6],
        #[ethevent(indexed)]
        pub oracle: ethers_core::types::Address,
    }
    #[derive(Clone, Debug, Default, Eq, PartialEq, ethers_contract :: EthEvent)]
    ...
    pub struct SeriesAddedFilter {
        ...
        pub base_id: [u8; 6],
        #[ethevent(indexed)]
        pub fy_token: ethers_core::types::Address,
    }
    #[derive(Clone, Debug, Default, Eq, PartialEq, ethers_contract :: EthEvent)]
    ...
    pub struct SeriesMaturedFilter {
        #[ethevent(indexed)]
        pub series_id: [u8; 6],
        pub rate_at_maturity: ethers_core::types::U256,
    }
    #[derive(Clone, Debug, Default, Eq, PartialEq, ethers_contract :: EthEvent)]
    #[ethevent(
        name = "SpotOracleAdded",
    ...
    impl ethers_core::abi::Tokenizable for CauldronEvents {
        fn from_token(
    ...
    impl ethers_core::abi::TokenizableItem for CauldronEvents {}
    impl ethers_contract::EthLogDecode for CauldronEvents {
